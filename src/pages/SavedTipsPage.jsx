...
export default function SavedTipsPage() {
    ...
    const handleDelete = (id) => {
        removeTip(id);
        setSavedTips(getSavedTips());
        showPopup("Removed from saved tips", "success");
    };
        ...
        return (
            <div className={`min-h-screen flex items-center justify-center ${darkMode
                ...
                <div className="max-w-3xl mx-auto px-4 py-8 text-center">
                    <h2 className={`text-2xl font-bold mb-2 ${darkMode
                            ? "text-gray-300 "
                            : "text-gray-800 "
                        }`}>Saved Tips</h2>
                    <p className={
                    ...
                    }>You haven’t saved any tips yet.</p>
            ...
            <div className="max-w-3xl mx-auto px-4 py-8">
                ...
                <div className="grid gap-6">
                    {savedTips.map((tip) => (
                        <div
                            key={tip.id}
                            className={`rounded-2xl p-5 border shadow-md transition ${darkMode
